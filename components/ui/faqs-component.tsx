        ...
        <section className="py-16 bg-muted md:py-24">
            <div className="px-4 mx-auto max-w-5xl md:px-6">
                <div>
                    ...
                    <p className="mt-4 text-lg text-muted-foreground text-balance">Discover quick and comprehensive answers to common questions about our platform, services, and features.</p>
                </div>
